...
export default function PrivacyPolicy() {
  return (
    <LegalDocumentLayout title="Privacy Policy">
      <>
        <p>
          This privacy policy applies to the vetrivel app (hereby referred to as &quot;Application&quot;) for mobile
          devices that was created by suresh menon (hereby referred to as &quot;Service Provider&quot;) as a Free
        ...
        <p>
          ...
          certain personally identifiable information, including but not limited to email, name, profile picture. The
        ...
        <p>
          ...
          please contact them at xbeyond.developer@gmail.com and they will respond in a reasonable time.
        </p>
        ...
        <div>
          <p>
            ...
            Application and/or Services. The Service Provider encourage parents and legal guardians to monitor their
            children&apos;s Internet usage and to help enforce this Policy by instructing their children never to provide
            any personally identifiable information through the Application and/or Services without their permission. If
            you have reason to believe that a child has provided personally identifiable information to the Service Provider
            through the Application and/or Services, please contact the Service Provider{' '}
            <span>(xbeyond.developer@gmail.com)</span> so that they will be able to take the necessary actions. You must
            also be at least 16 years of age to consent to the processing of your personally identifiable information in
        ...
        <p>This privacy policy is effective as of 2026-01-05</p>
        ...
        <p>
          ...
          please contact the Service Provider via email at xbeyond.developer@gmail.com.
        </p>
        <hr />
        <p>
