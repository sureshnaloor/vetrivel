...
export default function TermsConditions() {
  return (
    <LegalDocumentLayout title="Terms & Conditions">
      <>
        <p>
          These terms and conditions apply to the vetrivel app (hereby referred to as &quot;Application&quot;) for mobile
          devices that was created by suresh menon (hereby referred to as &quot;Service Provider&quot;) as a Free service.
        </p>
        <p>
        ...
        <p>
          ...
          for any loss, direct or indirect, that you experience as a result of relying entirely on this functionality of the
          application.
        </p>
        <p>
          ...
          to you. Unless they inform you otherwise, upon any termination, (a) the rights and licenses granted to you in these
